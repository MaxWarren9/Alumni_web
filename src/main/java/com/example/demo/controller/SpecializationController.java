...
public class SpecializationController {
    ...
    public ResponseEntity<List<SpecializationInfoResponse>> getAllSpecializations(
            ...
            Model model) {
        Page<SpecializationInfoResponse> specializations = specializationService.getAllSpecializations(page, perPage, sort, order, filter);
        model.addAttribute("specializations", specializations.getContent());
        return ResponseEntity.ok(specializations.getContent());
    }
//    @GetMapping
...
//                                        @RequestParam(required = false) String filter) {
//        Page<SpecializationInfoResponse> specializations = specializationService.getAllSpecializations(page, perPage, sort, order, filter);
//        model.addAttribute("specializations", specializations.getContent()); // Передача данных в шаблон
